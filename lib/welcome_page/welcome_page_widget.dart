...
class _WelcomePageWidgetState extends State<WelcomePageWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      logFirebaseEvent('welcomePage_set_app_language');
...
بۆ ڕێبەری */
                ...
                Padding(
                  ...
                  child: Text(
                    FFLocalizations.of(context).getText(
                      '28x0ezz5' /* تکایە گەر زمانی کوردی دەزانی ز... */,
                    ),
                    textAlign: TextAlign.center,
                    style: FlutterFlowTheme.of(context).bodyMedium.override(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'WELCOME_Container_njqszo0e_ON_TAP');
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'WELCOME_Container_49vrgm62_ON_TAP');
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text(
                                      'You will see less data compared to the Kurdish language.',
                                      style: TextStyle(
                                        color: Colors.white,
                                      ),
                                    ),
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'WELCOME_Container_serr8xfs_ON_TAP');
                                logFirebaseEvent('Container_set_app_language');
                                setAppLanguage(context, 'ar');
                                logFirebaseEvent('Container_update_app_state');
